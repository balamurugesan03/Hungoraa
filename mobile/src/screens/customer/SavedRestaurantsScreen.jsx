...
const styles = StyleSheet.create({
  ...
  imagePlaceholder: {
    height: 150, backgroundColor: '#f1f3f5', justifyContent: 'center', alignItems: 'center',
  },
  image: { width: '100%', height: '100%' },
  cardBody: { padding: SPACING.md },
  cardTop: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 10 },
  name: { fontSize: 16, fontWeight: '700', color: '#212529' },
  meta: { fontSize: 12, color: '#868e96', marginTop: 3 },
  heartBtn: { padding: 4 },
  cardBottom: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  ratingBadge: { backgroundColor: '#fff3e0', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
  ratingText: { fontSize: 12, fontWeight: '700', color: '#f4a261' },
  price: { fontSize: 13, color: '#495057', flex: 1 },
  ...
  emptyText: { fontSize: 14, color: '#868e96', textAlign: 'center', marginBottom: 24 },
